  ...
  return (
    <header className='main-header'>
      <div className='logo-container'>
        <img src='/src/assets/images/common/logo.png' alt='Logo' className='logo'/>
      </div>
      <div className={`mobile-nav ${sideBarActive ? 'open' : ''}`} onClick={openMobileSideBar}>
        <span></span>
        <span></span>
        <span></span>
      </div>
      <nav className='pc-nav'>
        <ul className='nav-list'>
          ...
          <li className={`language-selector ${globalActive ? 'open' : ''}`}>
            <div onClick={openGlobalSelector}>
